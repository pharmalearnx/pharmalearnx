...
def init_db():
    ...
    if not q_all("SELECT id FROM categories"):
        for c in ["GMP","QA","QC","Regulatory Affairs","Validation","Audit","Production","Microbiology","Warehouse","Others"]: execute("INSERT INTO categories(name) VALUES(?)",(c,))
